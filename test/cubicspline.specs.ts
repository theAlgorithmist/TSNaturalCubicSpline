...
import {TSMT$CubicSpline} from "../src/CubicSpline";
import {IKnot           } from "../src/CubicSpline";
...
// Test Suites
describe('Natural Cubic Spline: TSMT$CubicSpline', () =>
{
  const spline: TSMT$CubicSpline = new TSMT$CubicSpline();
  ...
  it('multi-point, returns correct interpolation points', () =>
  {
    ...
    const points:Array<IKnot> = spline.interpolationPoints;
