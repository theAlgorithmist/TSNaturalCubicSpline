...
/**
 * Typescript Math Toolkit: Minimal implementation of a natural cubic spline.  Reference the following white paper,
 * including variable descriptions:
 * <br/>
 * <br/>
 * http://algorithmist.net/docs/spline.pdf
 * <br/>
 * <br/>
 * Note that the term 'knots' is used frequently and interchangeably with interpolation points.  This reference comes
 * an ancient process for shipbuilding in which ropes were hung from a common beam and knots in the rope represented
 * points that defined a shape of a curve.
 *
...
export class TSMT$CubicSpline
{
  protected ONE_SIXTH: number = 0.1666666666667;
  ...
  {
    const knotArr: Array<IKnot> = new Array<IKnot>();
    let i: number = 0;
